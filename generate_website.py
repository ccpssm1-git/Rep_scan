    ...
    <nav class="fixed top-0 w-full z-50 glass-panel border-b border-gray-100 transition-all duration-300">
        <div class="container mx-auto px-6 h-20 flex items-center justify-between">
            ...
            <div class="hidden md:flex items-center gap-8 text-sm font-medium text-slate-600">
                ...
                <a href="#comparison" class="hover:text-blue-600 transition-colors">Vs ORM</a>
                <button class="open-scan-modal bg-slate-900 text-white px-6 py-2.5 rounded-full hover:bg-slate-800 transition-all shadow-lg hover:shadow-xl hover:-translate-y-0.5 font-semibold card-3d">Start Free Scan</button>
            </div>
        </div>
    </nav>
